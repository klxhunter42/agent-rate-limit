...
# Find the relay path's "var changed bool" and add index-change flush before it
# The relay path has Signature and Citations in the struct, sidecar doesn't
...
# Only replace in the second occurrence (relay path)
