...
var KnownModels = map[string]ModelCapabilities{
	// Anthropic
	"claude-opus-4-7":            {ContextWindow: 200000, MaxOutputTokens: 128000, Provider: "anthropic"},
	"claude-sonnet-4-6":          {ContextWindow: 200000, MaxOutputTokens: 128000, Provider: "anthropic"},
