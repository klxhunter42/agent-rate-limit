...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/Noooste/uquic-go)](https://pkg.go.dev/github.com/Noooste/uquic-go)
[![Code Coverage](https://img.shields.io/codecov/c/github/Noooste/uquic-go/master.svg?style=flat-square)](https://codecov.io/gh/Noooste/uquic-go/)
...
We are always happy to welcome new contributors! We have a number of self-contained issues that are suitable for first-time contributors, they are tagged with [help wanted](https://github.com/Noooste/uquic-go/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22). If you have any questions, please feel free to reach out by opening an issue or leaving a comment.

## License

The code is licensed under the MIT license. The logo and brand assets are excluded from the MIT license. See [assets/LICENSE.md](https://github.com/Noooste/uquic-go/tree/master/assets/LICENSE.md) for the full usage policy and details.
