...
[![Build Status](https://github.com/Noooste/utls/actions/workflows/go.yml/badge.svg?branch=master)](https://github.com/Noooste/utls/actions/workflows/go.yml) 
...
It LGTM, but please open up Wireshark and check. If you see something — [say something](https://github.com/Noooste/utls/issues).
...
There sure are. If you found one that approaches practicality at line speed — [please tell us](https://github.com/Noooste/utls/issues).
