...
func NewRegistry() *Registry {
	...
	r.providers["lotus"] = ProviderConfig{
		...
		Name:         "Lotus LLM",
		AuthType:     AuthTypeAPIKey,
		UpstreamBase: envOr("LOTUS_UPSTREAM_BASE", "https://api-cpxis.lotuss.com/llm"),
	}
	...
	r.providers["claude-oauth"] = ProviderConfig{
		...
		Scopes:       []string{"user:inference", "user:profile", "user:sessions:claude_code", "user:mcp_servers", "user:file_upload", "org:create_api_key"},
