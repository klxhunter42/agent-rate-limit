...
[Handler Layer] -- picks proxy based on provider routing
  ...
  +-- OpenAIProxy          (Z.AI / Lotus / OpenAI-compatible)
...
| `openai.go` | ~730 | OpenAI/Z.AI/Lotus proxy with auto-continuation and compaction |
...
**Parameters:**
- `maxContinuations`: 0 = no auto-continuation, >0 = enable (e.g., Lotus provider)
