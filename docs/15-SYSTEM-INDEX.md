...
| 17  | [Provider System](17-provider-system.md)                         | 1,031   | 20 built-in providers, resolver algorithm, OAuth flows (PKCE), token refresh (30min cycle), Redis key schema, 22 HTTP endpoints                                           |
