...
│Agents    │ ─── SSE ───────▶│  Rate Limit     │── Function ───▶│ Lotus    │
...
- Z.AI, OpenAI, Claude, Gemini, Lotus
...
| Lotus | OpenAI | Bearer | Tool use bridge with auto-continuation |
...
| 10 | [Lotus Provider](docs/10-lotus-provider.md) | Tool use bridge, 7 problems & fixes |
